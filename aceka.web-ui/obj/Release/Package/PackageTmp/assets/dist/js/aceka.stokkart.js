...
stokkartilkMadde.search = {
    init: function () {
     ...
     $('.aramaBtn').on('click', function () {
            ...
            var stokKartTipi = $("#stokkart_tipi_id").val();
            ...
            $.ajax({
                type: "GET",
                url: apiUrl + metodUrl + '?stok_adi=' + encodeURIComponent(stokAdi) + '&stok_kodu=' + encodeURIComponent(stokKodu) + '&stokkart_tur_id=' + stokKartTipi + '&orjinal_stok_kodu=' + encodeURIComponent(orjNo),
                dataType: "json",
                async: false,
...
stokkartilkMadde.get = {
        ...
        if (id > 0) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    //Zorunlu birimler kontrol ediliyor. Zorunlu tikli ise 'true' değerini döndürüyor.
    ...
    varyantlar: function (id) {
        if (id > 0) {
            //api/stokkart/sku-oto/{stokkart_id}
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data != null) {
                        table = $('#VaryantSkuKart').DataTable({
                            data: data,
                            paging: true,
                            destroy: true,
                            lengthChange: false,
                                ...
                                { data: "sezon_adi" },
                                 ...
                                 },
                                 {
                                     ...
                                     render: function (data, type, row) {
                                         if (type === 'display') {
                                             if (row.statu == true) {
                                                 return '<input type="checkbox" id="sezon_id" name="sezon_id" value="' + row.sezon_id + '" class="iCheck-helper" checked="checked"></input>';
                                             } else {
